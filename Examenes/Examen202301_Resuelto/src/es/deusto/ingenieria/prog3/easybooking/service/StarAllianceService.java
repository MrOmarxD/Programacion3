...
public class StarAllianceService extends AirAllianceService {
	...
	//TAREA 2.A - BASE DE DATOS: Carga los vuelos desde la BBDD. [20-30 líneas]
	...
	//TAREA 2.B - BASE DE DATOS: Guardar una reserva en la BBDD. [5-10 líneas]
	//Introduce aquí el código almcenarla una reserva en la BBDD. Los nombres de las personas
